...
aboutSchooles.command(['Да','Давай','Хочу','Можно','Расскажи'],async ctx=>{
...
firstSchool.command(['Да','Давай','Хочу','Можно','Расскажи'],async ctx =>{
...
alice.any(async ctx => {
    console.log(ctx)
    if(ctx.originalUtterance !== '')  {  return Reply.text(`Я Вас не понимаю`)}
    return Reply.text("")
});
